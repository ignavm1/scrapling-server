...
- [x] G1: el plan ataca el indice desde angulos DISTINTOS — incluye "<empresa> CEO" y "<empresa> gerente", aprovecha el dominio cuando se conoce, y ninguna query usa linkedin.com/in (con control positivo que planta una prohibida)
  ...
  EXPECT: G1_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=d2f3c88db83afb67f11fbcdff50760e3520f3bdca044fa88769117550adb921f; output-bytes=634
...
- [x] G2: extrae decisores del TEXTO de una pagina de equipo, no solo del snippet — que es donde F21 midio que estan los nombres — y no inventa personas en una pagina sin gente
  ...
  EXPECT: G2_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=26cd3142def54628e930b9f585d6554129d9261fde919708aa895c9ebc19fe41; output-bytes=634
...
- [x] G3: el ranking prefiere la evidencia mas fuerte — el sitio propio de la empresa gana sobre un tercero, el cargo que decide gana sobre el que no, y un candidato cuya empresa no aparece en ningun lado se descarta
  ...
  EXPECT: G3_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=06286e2ca65fe82bdfe329eaa674aa31e98c941ff92b93ee41d4b499be8ce362; output-bytes=634
...
- [x] G4: el resolutor completo encuentra al decisor sin tocar la red, y cuando no lo encuentra distingue "no publicado" de "los buscadores bloquearon"
  ...
  EXPECT: G4_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=beb1d4714b67b05743e643bf39f646cc122007c942b22bdbe89fbd0687ad25cb; output-bytes=634
...
- [x] G5: el endpoint nuevo devuelve el decisor con su evidencia y /search-linkedin conserva EXACTAMENTE su forma historica, que Venara ya consume
  ...
  EXPECT: G5_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=730b4a8ae614e0ef69fc74a8cdb4a0976a06b1600f48959bbfe3d7d5571e9f8d; output-bytes=635
...
- [x] G6: una consulta no puede volver a costar 4m43s — el gasto esta acotado por techo de fetches, presupuesto de tiempo y tope de paginas visitadas, y hay un control que falla si esos topes desaparecen
  ...
  EXPECT: G6_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=bf50bf9d58cd219ae7e211f2cc55d7d07b3ea01e272381b2872c5b35e2b01bc8; output-bytes=634
...
- [x] G7: la suite completa del servidor sigue verde, incluidos los tests que ya existian
  ...
  EXPECT: G7_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=f5014b45f9697d3a2b8d9d22c9f8d3f909b5b2ea553b7fb7b14f64bf62543b54; output-bytes=942
...
- [x] G8: la medicion en vivo sobre empresas reales produce un veredicto decisivo (decisores encontrados, o proveedores bloqueados nombrados) y lo deja escrito en un reporte
  ...
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=4764cd1d3ca45c4e6a623e43efe9985eddba574f9c1263214a8d87cd09d4fb7b; output-bytes=6714
...
- [x] G9: el pedido explicito de "buscar en Google" queda resuelto de forma honesta — se verifica contra el fixture capturado que Google no sirve resultados en el HTML, el sistema NO depende de el, y sigue funcionando con los buscadores que si responden
  ...
  EXPECT: G9_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=437f0b2c0808b9e45e4293db1ae4e6eebfb7f8f86114ccec8769b83396dbc5f1; output-bytes=634
...
- [x] G12: la misma persona no se devuelve dos veces — "Jaime Arrieta" y "Jaime Arrieta Boetsch" se fusionan — sin colapsar a dos personas distintas
  ...
  EXPECT: G12_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=dc2614f4d38e0cec4bd5550bb05d7c2464247dcaff623d88d136f81f6b1ef4c7; output-bytes=635
