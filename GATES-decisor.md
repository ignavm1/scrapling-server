...
- [x] G1: el plan ataca el indice desde angulos DISTINTOS — incluye "<empresa> CEO" y "<empresa> gerente", aprovecha el dominio cuando se conoce, y ninguna query usa linkedin.com/in (con control positivo que planta una prohibida)
  ...
  EXPECT: G1_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=50b6c1215e96bb5d505396d01c8485f5c44a9dc68c3a31fbf21b2c54ab38e0ec; output-bytes=635
...
- [x] G2: extrae decisores del TEXTO de una pagina de equipo, no solo del snippet — que es donde F21 midio que estan los nombres — y no inventa personas en una pagina sin gente
  ...
  EXPECT: G2_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=2a7a772c21cf5fef6e8c52fbdfaea06991f0ce1b80fc3afffa3ed618bf0deb42; output-bytes=635
...
- [x] G3: el ranking prefiere la evidencia mas fuerte — el sitio propio de la empresa gana sobre un tercero, el cargo que decide gana sobre el que no, y un candidato cuya empresa no aparece en ningun lado se descarta
  ...
  EXPECT: G3_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=de645a675a4b299d4a819c1d0bcc2ea09d027fff99546175cf438ed122bf1fce; output-bytes=634
...
- [x] G4: el resolutor completo encuentra al decisor sin tocar la red, y cuando no lo encuentra distingue "no publicado" de "los buscadores bloquearon"
  ...
  EXPECT: G4_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=c466b3970320798a91ab06a5f35959331a173b2c8fb6f1396a3e3f96612813b9; output-bytes=634
...
- [x] G5: el endpoint nuevo devuelve el decisor con su evidencia y /search-linkedin conserva EXACTAMENTE su forma historica, que Venara ya consume
  ...
  EXPECT: G5_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=571c73114e868384a1738690db16648029a9ad158e99e4015e5532ce501fd834; output-bytes=635
...
- [x] G6: una consulta no puede volver a costar 4m43s — el gasto esta acotado por techo de fetches, presupuesto de tiempo y tope de paginas visitadas, y hay un control que falla si esos topes desaparecen
  ...
  EXPECT: G6_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=7373394cc04ac6d6beade0bcb5fb1997edd48a87e23c8c1baa7b7326484affea; output-bytes=634
...
- [x] G7: la suite completa del servidor sigue verde, incluidos los tests que ya existian
  ...
  EXPECT: G7_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=e0f59119961ecab8b6a83e3073dc65dd8b04b6d35b604003e14ec0358e920407; output-bytes=942
...
- [x] G8: la medicion en vivo sobre empresas reales produce un veredicto decisivo (decisores encontrados, o proveedores bloqueados nombrados) y lo deja escrito en un reporte
  ...
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=7567b38a69837386b0559fa154334a6cd09456bb28ae80cbc709f129e11eece6; output-bytes=6367
...
- [x] G9: el pedido explicito de "buscar en Google" queda resuelto de forma honesta — se verifica contra el fixture capturado que Google no sirve resultados en el HTML, el sistema NO depende de el, y sigue funcionando con los buscadores que si responden
  ...
  EXPECT: G9_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=1b3cd413bdc39c5954d39149ab4fd9497b0f3cc78f5640dce63499e21488127c; output-bytes=634
...
- [x] G11: los falsos positivos que aparecieron en la medicion en vivo no vuelven — un cargo ("Chief Economist") ni una razon social ("Betterfly's Co") entran como persona — con control positivo de los decisores reales que la MISMA corrida encontro
  ...
  EXPECT: G11_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=607ec51da359a8c95cd74c50e2c755ef06de606e2fc2a17ce2b617789076bd61; output-bytes=635
...
- [x] G12: la misma persona no se devuelve dos veces — "Jaime Arrieta" y "Jaime Arrieta Boetsch" se fusionan — sin colapsar a dos personas distintas
  ...
  EXPECT: G12_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=b54dc127bd64bd56dce6cdc542e551edaa3ab38866212680d41108476524e47e; output-bytes=635
...
- [x] G13: /search-linkedin acepta un dominio OPCIONAL y con el usa el camino que entra al sitio — que es el unico que funciona cuando los buscadores bloquean — sin que un cliente viejo que no lo manda cambie de comportamiento
  ...
  EXPECT: G13_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=d3b4749b6b98cd1e78393238dec0fc84c33e57ed606947ffb14b36b5656fe0a6; output-bytes=635
