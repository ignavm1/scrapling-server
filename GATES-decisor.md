...
- [x] G1: el plan ataca el indice desde angulos DISTINTOS — incluye "<empresa> CEO" y "<empresa> gerente", aprovecha el dominio cuando se conoce, y ninguna query usa linkedin.com/in (con control positivo que planta una prohibida)
  ...
  EXPECT: G1_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=af872c9bb6e5640faff41456e72ae81d05d422adb88e3f1619274d7230f07a79; output-bytes=635
...
- [x] G2: extrae decisores del TEXTO de una pagina de equipo, no solo del snippet — que es donde F21 midio que estan los nombres — y no inventa personas en una pagina sin gente
  ...
  EXPECT: G2_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=014da95ddf7214bfea03f9cb66b3089651438b0f33b2166be8a9d67ad5bf619e; output-bytes=635
...
- [x] G3: el ranking prefiere la evidencia mas fuerte — el sitio propio de la empresa gana sobre un tercero, el cargo que decide gana sobre el que no, y un candidato cuya empresa no aparece en ningun lado se descarta
  ...
  EXPECT: G3_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=b2940a489bf6da1db5fb02fd15910127c3d64f138a5aff0e6cc62e06b10cfdca; output-bytes=634
...
- [x] G4: el resolutor completo encuentra al decisor sin tocar la red, y cuando no lo encuentra distingue "no publicado" de "los buscadores bloquearon"
  ...
  EXPECT: G4_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=cabf06b14729de2541618753df5327a37dbabe84ac1be7cd66bcfdf9f9a13904; output-bytes=634
...
- [x] G5: el endpoint nuevo devuelve el decisor con su evidencia y /search-linkedin conserva EXACTAMENTE su forma historica, que Venara ya consume
  ...
  EXPECT: G5_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=964e2a5a8ff24c9a52af2a2622dee64dd9fb22f8ee40eb0c837da972eb973a4e; output-bytes=635
...
- [x] G6: una consulta no puede volver a costar 4m43s — el gasto esta acotado por techo de fetches, presupuesto de tiempo y tope de paginas visitadas, y hay un control que falla si esos topes desaparecen
  ...
  EXPECT: G6_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=99a8e62879e721ed479587e70278adc81282512d85b057c228099a22ca910999; output-bytes=634
...
- [x] G7: la suite completa del servidor sigue verde, incluidos los tests que ya existian
  ...
  EXPECT: G7_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=3c1859d8be2ab20cc4e3c162dffea74ac2f96054b9e8d02ef915414f84390f3f; output-bytes=1022
...
- [x] G8: la medicion en vivo sobre empresas reales produce un veredicto decisivo (decisores encontrados, o proveedores bloqueados nombrados) y lo deja escrito en un reporte
  ...
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=e47ff45e09261fe000753d25b7fef56e1e12b076ae8a91995be0243463e22554; output-bytes=10621
...
- [x] G9: el pedido explicito de "buscar en Google" queda resuelto de forma honesta — se verifica contra el fixture capturado que Google no sirve resultados en el HTML, el sistema NO depende de el, y sigue funcionando con los buscadores que si responden
  ...
  EXPECT: G9_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=4d6edb76db1d49b350f2f41932f07eccf1c022fd7df36eacb475f1afe50cbbaf; output-bytes=634
...
- [x] G12: la misma persona no se devuelve dos veces — "Jaime Arrieta" y "Jaime Arrieta Boetsch" se fusionan — sin colapsar a dos personas distintas
  ...
  EXPECT: G12_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=f3e9e8a155278d489d4abc744c8c2f1e075fe7701ac25c10a1d3e1df350229ad; output-bytes=635
...
- [x] G13: /search-linkedin acepta un dominio OPCIONAL y con el usa el camino que entra al sitio — que es el unico que funciona cuando los buscadores bloquean — sin que un cliente viejo que no lo manda cambie de comportamiento
  ...
  EXPECT: G13_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=ec6a017cf96ebfed6d0c03f413e0f43d36f0dd8416d9e3a5720e3dfe2b018d63; output-bytes=635
