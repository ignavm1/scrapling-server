...
- [x] G1: si el sitio publica el email de ESA persona, se devuelve tal cual con fuente "publicado", y un email de otro empleado NO se le atribuye
  ...
  EXPECT: G1_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=e95c5e8a51af/24 entries; EXPECT=matched; output-sha256=9f270d84368c99e524c2fa84d12c1ed6ecc7919297e0c26fe4524115b25877ac; output-bytes=119
...
- [x] G2: con una muestra real del dominio se deduce el patron y se construye el email de la persona citando la muestra; SIN muestra no se construye ninguno
  ...
  EXPECT: G2_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=e95c5e8a51af/24 entries; EXPECT=matched; output-sha256=88ae89a80a4641b9a01f832b596fbe2c0acc737cdd27d43b99958bc558cfffd9; output-bytes=119
...
- [x] G3: cuando no hay nada personal se devuelve el buzon generico etiquetado como generico, nunca como si fuera de la persona
  ...
  EXPECT: G3_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=e95c5e8a51af/24 entries; EXPECT=matched; output-sha256=cfc624faa85bc090c8b8d0c5de08079ecadeb7a0f20353ad8edbb667fc711f62; output-bytes=119
...
- [x] G4: el telefono se normaliza a E.164 y se distingue movil de fijo, porque un fijo no tiene WhatsApp y guardarlo como si lo tuviera genera una tarea que nunca llega
  ...
  EXPECT: G4_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=e95c5e8a51af/24 entries; EXPECT=matched; output-sha256=5b657974c38a912064bda0d61df9c4166957a720e4ffd03bffe8ccda93594ef6; output-bytes=119
...
- [x] G5: ningun contacto se devuelve sin su procedencia y su confianza -- un dato sin origen no se puede auditar cuando rebota
  ...
  EXPECT: G5_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=e95c5e8a51af/24 entries; EXPECT=matched; output-sha256=682a7d63799912ee93971187316924355b3e00c17bfcd907c198dfc7a33d5fb5; output-bytes=119
...
- [x] G6: el resolutor entrega el contacto junto al decisor y el endpoint lo expone, sin romper el camino del sitio propio ni el angulo de LinkedIn
  ...
  EXPECT: G6_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=e95c5e8a51af/24 entries; EXPECT=matched; output-sha256=fee19936973fe22b88535aa0d831720ea9f0f9b3ebf6c7ed2d64e80c2fb5491e; output-bytes=635

- [x] G7: la suite completa del servidor sigue verde
  CHECK: .venv/bin/python -m pytest -q && echo G7_OK
  EXPECT: G7_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=e95c5e8a51af/24 entries; EXPECT=matched; output-sha256=10a7600898371e528fb88dc18c9ccc6e946b0cc22ad997b13a9d519da5f28824; output-bytes=1022
...
- [x] G8: la medicion en vivo sobre empresas reales dice cuantos decisores quedaron con canal de contacto y de que tipo, con veredicto decisivo por empresa
  ...
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=e95c5e8a51af/24 entries; EXPECT=matched; output-sha256=c73a399be98e6e661b7a302918a5ae00173df68330dd1006c38be97f861e7bac; output-bytes=21273
