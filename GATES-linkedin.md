...
- [x] G1: el angulo pide el perfil como lo pidio el usuario -- "<empresa> <cargo> linkedin" -- y NO usa site:linkedin.com/in, que esta medido inutil en los proveedores disponibles, con control positivo que planta la query prohibida
  ...
  EXPECT: G1_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=a448dc8a5c581c5c303ed682bf40e866d36a654f3d20bda4fb0062cb59948555; output-bytes=119
...
- [x] G5: el resolutor integra el angulo sin romper el camino del sitio propio, que es el que mejor rinde
  ...
  EXPECT: G5_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=551babd6def1d99e999373c5d5114a0ae51a7b30c39352894565cd341050cf18; output-bytes=620

- [x] G6: la suite completa del servidor sigue verde
  CHECK: .venv/bin/python -m pytest -q && echo G6_OK
  EXPECT: G6_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=3b7b93a92da9111354d0581eff29684b7483c71c490b94ea998563f4120b0f09; output-bytes=1022
...
- [x] G7: la medicion en vivo sobre empresas reales produce un veredicto decisivo por empresa y lo deja escrito en un reporte
  ...
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=6f625a5facbc9b4c3ab98592bbc31a23bb9d5eead72925dbdf4345e463f81af5; output-bytes=14320
...
- [x] G8: el pedido de "buscar en Google" queda resuelto con medicion FRESCA, no citando una vieja -- se verifica hoy que Google no sirve resultados por HTTP y que el sistema no depende de el
  ...
  EXPECT: G8_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/ignaciovenegas/Desktop/scrapling-server; path=4071c558d3a5/24 entries; EXPECT=matched; output-sha256=13c447245d59f6b0315a0705a8670dc9010bb55c7518f867b69401ecf226c317; output-bytes=119
